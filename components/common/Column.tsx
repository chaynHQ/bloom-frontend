...
// The named column widths an editor picks from, as a share of the row.
  ...
  const columnStyles = {
    ...
    ...(size
      ? {
          ...
          // From `md` the authored width is a share of the row rather than a fixed percentage, so
          // columns tile the full width and the gap comes out of the shared space.
          flexBasis: { md: 0 },
