...
const twitterDescriptionContent =
  "Learn & heal from trauma in a private, supportive space. Our courses are written & checked by survivors, allies, mental health support workers and therapists. We're here for you.";
