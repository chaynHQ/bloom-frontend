...
/**
 * Note that this component is to be specifically used for the image based abuse (IBA) course.
 * It makes use of a subtitle in session which is only available in the "Session IBA" storyblok block.
 */
const cardStyle = {
...
const IbaSessionCard = (props: SessionCardProps) => {
    ...
    <Card sx={cardStyle}>
      ...
      >
        <CardContent sx={cardContentStyle}>
          ...
          <Typography color="grey.700">{session.content.subtitle}</Typography>
        </CardContent>
      </CardActionArea>
