...
/**
 * Dispatched by the cookie banner when the user accepts or declines, so banners waiting on that
 * decision (e.g. the PWA install banner) appear immediately rather than on the next page load.
 */
...
/** Whether the user has accepted or declined the cookie banner. */
