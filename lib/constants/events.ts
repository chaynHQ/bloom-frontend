...
export const HOME_CONTENT_CARD_CLICKED = 'HOME_CONTENT_CARD_CLICKED';
export const HOME_BROWSE_ALL_CLICKED = 'HOME_BROWSE_ALL_CLICKED';
export const HOME_CONTINUE_CARD_CLICKED = 'HOME_CONTINUE_CARD_CLICKED';
export const HOME_SUPPORT_CARD_CLICKED = 'HOME_SUPPORT_CARD_CLICKED';
export const HOME_CAROUSEL_PAGED = 'HOME_CAROUSEL_PAGED';

export const RESOURCE_CAROUSEL_PAGED = 'RESOURCE_CAROUSEL_PAGED';
...
// CONTACT / FEEDBACK / BUG FORMS (components/contact/)
export const CONTACT_DIALOG_OPENED = 'CONTACT_DIALOG_OPENED'; // { type, source }
export const CONTACT_FORM_SWITCHED = 'CONTACT_FORM_SWITCHED'; // { from, to }
export const CONTACT_FORM_SUBMITTED = 'CONTACT_FORM_SUBMITTED'; // { type, source }
export const CONTACT_FORM_ERROR = 'CONTACT_FORM_ERROR'; // { type }
export const CONTACT_SUPPORT_SIGNPOST_CLICKED = 'CONTACT_SUPPORT_SIGNPOST_CLICKED';
