...
import SessionCard from '@/lib/components/cards/SessionCard';
import { ContentUnavailable } from '@/lib/components/common/ContentUnavailable';
import CourseHeader from '@/lib/components/course/CourseHeader';
import CourseIntroduction from '@/lib/components/course/CourseIntroduction';
